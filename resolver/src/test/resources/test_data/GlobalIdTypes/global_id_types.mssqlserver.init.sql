EXEC ('CREATE SCHEMA resolver_testing_global_id_types');
...
CREATE TABLE resolver_testing_global_id_types.date_time (
                                           date_id date UNIQUE,
                                           time_id time UNIQUE,
                                           date_time_id datetimeoffset UNIQUE,
...
CREATE TABLE resolver_testing_global_id_types.lookup_table (
       ...
       parent_date_time_id datetimeoffset references resolver_testing_global_id_types.date_time(date_time_id),
