CREATE SCHEMA resolver_testing_order_product_order_item;
...
CREATE TABLE resolver_testing_order_product_order_item.my_order_item (
    parent_order_id character varying REFERENCES resolver_testing_order_product_order_item.my_order,
    parent_product_id character varying REFERENCES resolver_testing_order_product_order_item.my_product,
    quantity int,
...
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-299', 'cantaloupe', 50, false);
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-300', 'apple', 10, false);
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-301', 'banana', 20, false);
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-302', 'watermelon', 30, false);
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-303', 'lemon', 40, false);
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-304', 'orange', 50, false);
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-305', 'lime', 60, false);
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-306', 'persimmon', 70, false);
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-307', 'grapefruit', 80, false);
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-308', 'blueberry', null, false);
INSERT INTO resolver_testing_order_product_order_item.my_product (product_id, name, price, discontinued) VALUES ('PRD-309', 'strawberry', 100, false);
